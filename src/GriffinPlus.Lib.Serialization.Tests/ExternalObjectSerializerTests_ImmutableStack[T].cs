...
public abstract class ExternalObjectSerializerTests_ImmutableStackT
{
	...
	public static IEnumerable<object[]> TestData
	{
		get
		{
			...
			yield return ["ImmutableStack<string>, empty", ImmutableStack<string>.Empty];
			yield return ["ImmutableStack<string>, 3 items", ImmutableStack.Create("Alpha", "Beta", "Gamma")];

			// int elements (value type, built-in serialization support)
			yield return ["ImmutableStack<int>, empty", ImmutableStack<int>.Empty];
			yield return ["ImmutableStack<int>, 5 items", ImmutableStack.Create(1, 2, 3, 4, 5)];

			// complex object elements (requires custom external object serializer)
			yield return
			[
				"ImmutableStack<TestClassWithExternalObjectSerializer>, 2 items",
				ImmutableStack.Create(
	...
	public class SpeedOptimized : ExternalObjectSerializerTests_ImmutableStackT
	{
	...
	public class SizeOptimized : ExternalObjectSerializerTests_ImmutableStackT
	{
		protected override Serializer CreateSerializer()
		{
