...
public abstract class ExternalObjectSerializerTests_ImmutableHashSetT
{
	...
	public static IEnumerable<object[]> TestData
	{
		get
		{
			...
			yield return ["ImmutableHashSet<string>, empty", ImmutableHashSet<string>.Empty];
			yield return ["ImmutableHashSet<string>, 3 items", ImmutableHashSet.Create("Alpha", "Beta", "Gamma")];

			// int elements (value type, built-in serialization support)
			yield return ["ImmutableHashSet<int>, empty", ImmutableHashSet<int>.Empty];
			yield return ["ImmutableHashSet<int>, 5 items", ImmutableHashSet.Create(1, 2, 3, 4, 5)];
		}
	}
	...
	public class SpeedOptimized : ExternalObjectSerializerTests_ImmutableHashSetT
	{
	...
	public class SizeOptimized : ExternalObjectSerializerTests_ImmutableHashSetT
	{
		protected override Serializer CreateSerializer()
		{
