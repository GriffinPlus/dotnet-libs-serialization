...
public abstract class ExternalObjectSerializerTests_ImmutableSortedDictionaryT
{
	...
	public static IEnumerable<object[]> TestData
	{
		get
		{
			...
			yield return ["ImmutableSortedDictionary<char,string>, empty", ImmutableSortedDictionary<char, string>.Empty];
			yield return
			[
				"ImmutableSortedDictionary<char,string>, 3 items",
				ImmutableSortedDictionary<char, string>.Empty
					.Add('A', "Alpha")
					.Add('B', "Beta")
					.Add('C', "Gamma")
			];
			...
			yield return ["ImmutableSortedDictionary<string,int>, empty", ImmutableSortedDictionary<string, int>.Empty];
			yield return
			[
				"ImmutableSortedDictionary<string,int>, 3 items",
			...
			yield return
			[
				"ImmutableSortedDictionary<int,TestClassWithExternalObjectSerializer>, 2 items",
				ImmutableSortedDictionary<int, SerializerTests_Base.TestClassWithExternalObjectSerializer>.Empty
	...
	public class SpeedOptimized : ExternalObjectSerializerTests_ImmutableSortedDictionaryT
	{
	...
	public class SizeOptimized : ExternalObjectSerializerTests_ImmutableSortedDictionaryT
	{
		protected override Serializer CreateSerializer()
		{
