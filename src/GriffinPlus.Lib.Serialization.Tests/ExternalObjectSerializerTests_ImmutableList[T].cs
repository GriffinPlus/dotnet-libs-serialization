...
public abstract class ExternalObjectSerializerTests_ImmutableListT
{
	...
	public static IEnumerable<object[]> TestData
	{
		get
		{
			...
			yield return ["ImmutableList<string>, empty", ImmutableList<string>.Empty];
			yield return ["ImmutableList<string>, 3 items", ImmutableList.Create("Alpha", "Beta", "Gamma")];

			// int elements (value type, built-in serialization support)
			yield return ["ImmutableList<int>, empty", ImmutableList<int>.Empty];
			yield return ["ImmutableList<int>, 5 items", ImmutableList.Create(1, 2, 3, 4, 5)];

			// complex object elements (requires custom external object serializer)
			yield return
			[
				"ImmutableList<TestClassWithExternalObjectSerializer>, 2 items",
	...
	public class SpeedOptimized : ExternalObjectSerializerTests_ImmutableListT
	{
	...
	public class SizeOptimized : ExternalObjectSerializerTests_ImmutableListT
	{
		protected override Serializer CreateSerializer()
		{
