...
/// <summary>
/// External object serializer for the <see cref="SortedDictionary{TKey,TValue}"/> class.
/// </summary>
[ExternalObjectSerializer(1)]
public class ExternalObjectSerializer_SortedDictionary<TKey, TValue> : ExternalObjectSerializer<SortedDictionary<TKey, TValue>>
{
	/// <summary>
