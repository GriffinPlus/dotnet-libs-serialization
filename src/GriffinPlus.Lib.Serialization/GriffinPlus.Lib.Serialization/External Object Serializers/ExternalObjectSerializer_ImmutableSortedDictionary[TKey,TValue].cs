...
/// <summary>
/// External object serializer for the <see cref="ImmutableSortedDictionary{TKey,TValue}"/> class.
/// </summary>
[ExternalObjectSerializer(1)]
public class ExternalObjectSerializer_ImmutableSortedDictionary<TKey, TValue> : ExternalObjectSerializer<ImmutableSortedDictionary<TKey, TValue>>
{
	/// <summary>
	...
	public override void Serialize(SerializationArchive archive, ImmutableSortedDictionary<TKey, TValue> dictionary)
	{
	...
	/// <exception cref="VersionNotSupportedException">Serializer version is not supported.</exception>
	public override ImmutableSortedDictionary<TKey, TValue> Deserialize(DeserializationArchive archive)
	{
		// ReSharper disable once InvertIf
		if (archive.Version == 1)
		{
			...
			ImmutableSortedDictionary<TKey, TValue>.Builder builder = ImmutableSortedDictionary.CreateBuilder<TKey, TValue>();
