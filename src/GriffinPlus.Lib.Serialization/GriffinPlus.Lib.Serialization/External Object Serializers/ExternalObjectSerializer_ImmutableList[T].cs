...
/// <summary>
/// External object serializer for the <see cref="ImmutableList{T}"/> class.
/// </summary>
[ExternalObjectSerializer(1)]
public class ExternalObjectSerializer_ImmutableList<T> : ExternalObjectSerializer<ImmutableList<T>>
{
	/// <summary>
	...
	public override void Serialize(SerializationArchive archive, ImmutableList<T> list)
	{
	...
	/// <exception cref="VersionNotSupportedException">Serializer version is not supported.</exception>
	public override ImmutableList<T> Deserialize(DeserializationArchive archive)
	{
		// ReSharper disable once InvertIf
		if (archive.Version == 1)
		{
